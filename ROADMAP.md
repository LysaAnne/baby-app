...
| 2026-08-17 | Completed the first visual-cleanup pass with a scannable Today overview, shared section/card patterns, compact records, dedicated timeline filters, consistent family actions, full-screen long forms, improved empty states, and a separate developer-tools screen. | Cross-stage UX | Complete |
| 2026-08-17 | Completed the first technical-cleanup pass by extracting event presentation and shared labels, moving timer and sleep-overlap rules into the domain layer, making combined UI state type-safe, and removing duplicate legacy provider fields through tested Room migration 14–15. | Cross-stage architecture | Complete |
